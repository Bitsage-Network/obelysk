    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          {/* ── Send Stealth Payment (redirect to /send) ── */}
          <motion.div
            variants={stagger.item}
            className="relative overflow-hidden rounded-2xl border border-white/[0.05] bg-gradient-to-br from-surface-card via-surface-card to-fuchsia-950/10 p-6 space-y-4"
          >
            ...
            <div className="grid grid-cols-2 gap-2 text-[11px]">
              ...
              <div className="p-2.5 rounded-lg bg-black/20 border border-white/[0.04]">
                ...
                <p className="text-fuchsia-400 font-medium">Hidden (one-time address)</p>
              </div>
            </div>

            <Link
              href="/send?mode=stealth"
              className="w-full py-3 rounded-xl text-sm font-semibold transition-all flex items-center justify-center gap-2 bg-gradient-to-r from-fuchsia-600 to-indigo-600 hover:from-fuchsia-500 hover:to-indigo-500 text-white active:scale-[0.98]"
            >
              <Send className="w-4 h-4" />
              Send via Stealth
            </Link>
